...
(function(root, factory) {
  ...
  const profiles = {
    155: {feature: 'anyangTwoFoulsZero2027', events: ['제자리멀리뛰기', '배근력'], finalCodes: ['2회파울'], finalAliases: {'2F': '2회파울', '2회 파울': '2회파울'}, finalMessage: '안양대 2회 파울이 확정되면 2회파울 또는 2F를 입력해 주세요.', eventMaximum: 100, maximum: 60},
  ...
  return {year: 2027, anyangUid: 155, feature: 'fivePractical2027Reviewed', profiles, finalCodes: ['F', '파울'],
    ...
    conditionalRules: [
      {key: 'anyangFoul', ids: [155], records: ['2회파울']},
    ...
    notices: {anyangFoul: '안양 2회 파울 · 상담 기준 0점', yongin: '용인 제멀 경계 · 상담 기준 적용', wonkwang: '원광 배구 중복 경계 · 상담 기준 적용',
